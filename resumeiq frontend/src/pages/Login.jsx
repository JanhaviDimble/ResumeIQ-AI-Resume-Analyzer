...
const Login = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-700 via-blue-600 to-indigo-900"></div>

      {/* Floating circles */}
      <div className="absolute top-10 left-10 w-32 h-32 bg-purple-400 opacity-20 rounded-full animate-pulse"></div>
      <div className="absolute top-40 right-20 w-20 h-20 bg-blue-300 opacity-20 rounded-full animate-bounce"></div>
      <div className="absolute bottom-20 left-20 w-40 h-40 bg-indigo-400 opacity-20 rounded-full animate-pulse"></div>
      <div className="absolute bottom-10 right-10 w-24 h-24 bg-purple-300 opacity-20 rounded-full animate-bounce"></div>

      {/* Floating AI + Resume icons */}
      <div className="absolute top-16 right-40 text-6xl opacity-20 animate-bounce">🤖</div>
      <div className="absolute bottom-32 left-40 text-5xl opacity-20 animate-pulse">📄</div>
      <div className="absolute top-32 left-1/4 text-4xl opacity-20 animate-bounce">💼</div>
      <div className="absolute bottom-16 right-1/4 text-5xl opacity-20 animate-pulse">🎯</div>
      <div className="absolute top-1/2 left-10 text-4xl opacity-20 animate-bounce">📊</div>
      <div className="absolute top-1/2 right-10 text-4xl opacity-20 animate-pulse">✨</div>
      ...
      <div className="relative z-10 bg-white bg-opacity-10 backdrop-blur-md rounded-3xl shadow-2xl p-10 w-full max-w-md border border-white border-opacity-20">
        <div className="text-center mb-8">
          ...
          <p className="text-purple-200 mt-2">AI Powered Resume Analyzer</p>
        </div>
        ...
        <p className="text-center text-purple-200 mt-6">
          ...
          <Link to="/register" className="text-yellow-300 font-bold hover:underline">Register →</Link>
        </p>
      </div>
    </div>
  );
